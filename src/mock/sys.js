...
Mock.mock('/api/sys/register', 'post', (options) => {
  ...
  for (const value of allUserList) {
    if (value.username === options.body.username) {
      return {
        ...
        code: 10000,
        data: {},
        message: i18n.t('mock.sys.268235-0')
      }
    }
  }
  // 注册成功
  ...
  return {
    ...
    code: 10000,
    data: {},
    message: i18n.t('mock.sys.268235-1')
  }
})
...
Mock.mock('/api/sys/login', 'post', (options) => {
  ...
  return {
    ...
    code: 10000,
    data: {},
    message: i18n.t('mock.sys.268235-2')
  }
})
    ...
    return {
      ...
      data: {
        role: [
          {
            id: '1',
            title: i18n.t('mock.sys.268235-3')
          }
        ],
      ...
      message: i18n.t('mock.sys.268235-4')
    }
  } else {
    return {
      success: false,
      code: 200,
      message: i18n.t('mock.sys.268235-5')
    }
  }
})
